...
/**
 * Get the official NBA team logo URL for a given team abbreviation
 * @param teamAbbreviation - The team's abbreviation (e.g., "LAL", "GSW")
 * @returns The official NBA logo URL or empty string if not found
 */
export const getTeamLogoUrl = (teamAbbreviation: string): string => {
  // Map team abbreviations to NBA logo URLs
  ...
  return teamLogoMap[teamAbbreviation] || ""
}
